...
hi OL2 guifg=steelblue    ctermfg=lightblue
hi OL3 guifg=deepskyblue2 ctermfg=lightblue
hi OL4 guifg=steelblue	  ctermfg=magenta
hi OL5 guifg=deepskyblue2 ctermfg=white
hi OL6 guifg=steelblue	  ctermfg=red
hi OL7 guifg=deepskyblue2 ctermfg=lightblue
hi OL8 guifg=steelblue	  ctermfg=magenta
hi OL9 guifg=deepskyblue2 ctermfg=white

" colors for tags
hi outlTags guifg=darkred	ctermfg=darkred

" color for body text
hi BT1 guifg=lightblue   ctermfg=green
hi BT2 guifg=lightblue 	ctermfg=green
hi BT3 guifg=lightblue   ctermfg=green
hi BT4 guifg=lightblue 	ctermfg=green
hi BT5 guifg=lightblue   ctermfg=green
hi BT6 guifg=lightblue   ctermfg=green
hi BT7 guifg=lightblue   ctermfg=green
hi BT8 guifg=lightblue   ctermfg=green
hi BT9 guifg=lightblue   ctermfg=green
...
hi Folded guifg=cyan guibg=bg	ctermfg=cyan ctermbg=black
hi FoldColumn guifg=cyan guibg=bg	ctermfg=cyan ctermbg=black
