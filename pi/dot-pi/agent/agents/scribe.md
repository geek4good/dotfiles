...
| Edit existing docs | Allowed |
| Create/edit code | NOT allowed |
| Run bash commands | NOT allowed |
| Delete files | NOT allowed |
...
- NEVER include AI attribution (no "Generated by Claude", etc.)
