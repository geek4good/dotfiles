...
|----------|------|----------|-----------------|
| Critical | :red_circle: | Security vulnerabilities, crashes, data loss, corruption | Must fix before merge |
| Major | :orange_circle: | Bugs, performance issues, missing error handling | Should fix |
| Minor | :yellow_circle: | Code smells, maintainability issues, test gaps | Nice to fix |
| Nitpick | :green_circle: | Style preferences, naming suggestions, documentation | Optional |
